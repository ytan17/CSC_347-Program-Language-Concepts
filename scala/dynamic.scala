...
object dynamic {
  ...
  // class greeter extends Internationalization{
  ...
  def newEnglish () : Internationalization = {
    ...
    return new greeter //instance of a class
  }
  ...
  def newFrench () : Internationalization = {
    // TODO: Provide definition here.
    class greeter extends Internationalization{
      def greet(name :String) : String = {return ("Bonjour" + " " + name)}
    }
    return new greeter
  }
}
